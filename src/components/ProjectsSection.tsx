                  ...
                  <div className="relative group">
                    ...
                    <div className="relative p-8 md:p-10 flex flex-col md:flex-row md:items-center gap-4 md:gap-10">
                      <div className="flex-1">
                        <h3 className="font-heading text-xl md:text-2xl font-semibold mb-2">{project.title[lang as Lang]}</h3>
                        <p className="text-muted-foreground leading-relaxed mb-3">{project.description[lang as Lang]}</p>
                        ...
                        <div className="pt-8 grid md:grid-cols-2 gap-8">
                          {project.image && (
                            <div className="rounded-lg overflow-hidden border border-border">
                              <img src={project.image} alt={`${project.title[lang as Lang]} preview`} className="w-full h-full object-cover" />
                            </div>
                          )}
                          <div className={`flex flex-col justify-between ${!project.image ? "md:col-span-2" : ""}`}>
                            <div>
                              <h4 className="font-heading font-semibold text-lg mb-3">{t("projects", "details")}</h4>
                              <p className="text-muted-foreground leading-relaxed text-sm">{project.details[lang as Lang]}</p>
                            </div>
