...
const iconMap = { Code2, Palette, Zap } as const;
          ...
          {skills.map((skill, i) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="font-heading font-semibold text-lg mb-2">{skill.title[lang as Lang]}</h3>
                <p className="text-muted-foreground text-sm leading-relaxed">{skill.description[lang as Lang]}</p>
              </motion.div>
            );
          })}
        </div>
        ...
        <div className="space-y-6">
          {education.map((edu, i) => (
            ...
            >
              ...
              <h4 className="font-heading font-semibold text-lg">{edu.title[lang as Lang]}</h4>
              <p className="text-muted-foreground text-sm mb-1">{edu.institution[lang as Lang]}</p>
              <p className="text-muted-foreground text-sm leading-relaxed">{edu.description[lang as Lang]}</p>
            </motion.div>
          ))}
        </div>
      </div>
